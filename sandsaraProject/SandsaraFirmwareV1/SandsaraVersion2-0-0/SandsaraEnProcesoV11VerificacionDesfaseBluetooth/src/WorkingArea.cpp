...
String checkGapPositiveb1();
String checkGapNegativeb1();
String checkGapPositiveb2();
String checkGapNegativeb2();
...
void WorkingArea::prepareMotors()
{
	...
	tmcMotorA.ihold(I_HOLD);
	tmcMotorB.ihold(I_HOLD);
	...
	while (true)
	{
		...
		if (sensorRead1 > sensorMax1 || sensorRead1 < sensorMin1) //stop first arm condition.
		{
			if (avoid == 0)
			{
				...
				//Test desfase hasta ver deformacion
				/*
				digitalWrite(EN_PIN2, LOW);
				digitalWrite(EN_PIN, LOW);
				digitalWrite(DIR_PIN2, HIGH);
...
String WorkingArea::checkErrorGap()
{
	String resultB1;
	String resultB2;
	if (sensorPole1 == 1)
	{
		resultB1 = checkGapPositiveb1();
	}
	if (sensorPole1 == 0)
	{
		resultB1 = checkGapNegativeb1();
	}
	if (sensorPole2 == 1)
	{
		resultB2 = checkGapPositiveb2();
	}
	if (sensorPole2 == 0)
	{
		resultB2 = checkGapNegativeb2();
	}
 ...
 */
String checkGapPositiveb1(void)
{
	digitalWrite(EN_PIN2, LOW);
	digitalWrite(EN_PIN, LOW);
	int value1_f;
 ...
 * 
 */
String checkGapPositiveb2(void)
{
	digitalWrite(EN_PIN2, LOW);
	digitalWrite(EN_PIN, LOW);
	int value1_f;
 ...
 * 
 */
String checkGapNegativeb1(void)
{
	digitalWrite(EN_PIN2, LOW);
	digitalWrite(EN_PIN, LOW);
	int value1_f;
 ...
 * 
 */
String checkGapNegativeb2(void)
{
	digitalWrite(EN_PIN2, LOW);
	digitalWrite(EN_PIN, LOW);
	int value1_f;
