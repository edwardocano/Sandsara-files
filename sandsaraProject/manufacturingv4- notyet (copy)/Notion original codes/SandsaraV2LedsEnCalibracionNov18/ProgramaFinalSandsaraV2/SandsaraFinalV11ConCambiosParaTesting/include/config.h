...
#define v2Current 0
#define v3Current 1
#define SANDSARAMODEL "V1"
#define simpleVersion 1
#endif
...
#define v2Current 0
#define v3Current 1
#define SANDSARAMODEL "V2"
#define simpleVersion 2
#endif
...
#ifdef PCB_Lalo
#define DIR_PIN 17   // 33      //32
#define STEP_PIN 16  // 25      //33
#define EN_PIN 25    // 14      //25
#define DIR_PIN2 32  // 4       //17
#define STEP_PIN2 33 // 21      //16
#define EN_PIN2 25   // 15      //25
...
#define PIN_ProducType 35 // 35
#define SENSOR_HALL_PIN 14
...
#define TRACKS_BEFORE_CALIBRATION 10
...
#define ADDRESSTIMEPATHS 300
#define ADDRESSTIMEOFFON 320
#define ADDRESSPLAYLISTMODE 350
#define ADDRESSPOLESENSE1 401
#define ADDRESSPOLESENSE2 402
#define ADDRESSESTOVERIFY 14
#define ADDRESSBRIGHTNESS 170 // 1 byte
#define ADDRESSREBOOTS 460
#define ADDRESSMODEL 470
#define ADDRESSTRACKSCALIB 506
...
//
#define ACCEL_THRESHOLD 500.0 // Original 500.0
#define SAFE_SPEED 1.0
#define MAX_STEPS_PER_INSTRUCTION 100.0 // Original 100.0
#define SAMPLES 50
 ...
 */
#define SPEED_MOTOR_DEFAULT 25 // Max 120 Min 25
