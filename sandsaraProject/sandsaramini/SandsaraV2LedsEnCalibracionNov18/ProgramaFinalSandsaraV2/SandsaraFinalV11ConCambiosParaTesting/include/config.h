...
#ifdef PCB_Lalo
#define DIR_PIN    32 // 17        //33      //32       
#define STEP_PIN   33 // 16        //25      //33
#define EN_PIN     25 //25        //14      //25
#define DIR_PIN2   17 //32        //4       //17
#define STEP_PIN2  16 //33        //21      //16
#define EN_PIN2    25 //25        //15      //25
